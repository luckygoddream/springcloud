...
public class PaymentController {
    ...
    public CommonResult create(@RequestBody Payment payment){
       ...
       return result > 0 ? new CommonResult(200,"插入数据成功,serverPort: "+serverPort,result) : new CommonResult(400,"插入数据失败",null);
//        if (result > 0){
...
//        }
    ...
    public CommonResult getPaymentById(@PathVariable("id") Long id){
        ...
        log.info("serverPort:{}",serverPort);
        return result != null ? new CommonResult(200,"查询数据成功,serverPort: "+serverPort,result) : new CommonResult(400,"查询数据失败",null);
